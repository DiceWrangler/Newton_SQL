--
--  view_customers_by_sales_period.sql
--

-- View: vcustomers_by_sales_period

DROP VIEW IF EXISTS vcustomers_by_sales_period;

CREATE VIEW vcustomers_by_sales_period AS
